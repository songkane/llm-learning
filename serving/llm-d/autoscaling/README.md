...
> **相关系列**：[llm-d Router](../router/)（决定请求发给哪个副本）｜ [NVIDIA Dynamo](../../dynamo/)（同层的另一套服务栈）｜ [kube-scheduler](../../../scheduling/kube-scheduler/) / [Volcano](../../../scheduling/volcano/)（决定 Pod 落在哪个节点）
> **回到** [llm-d 总览](../README.md) ｜ [推理服务栈](../../README.md) ｜ [弹性扩缩容索引](../../../autoscaling/README.md)
